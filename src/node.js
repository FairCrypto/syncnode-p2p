...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var peerId, options, libp2p;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                peerId = process.argv.slice(2)[0];
                options = {
                // add options
                };
                return [4 /*yield*/, (0, libp2p_1.createLibp2p)({
                        peerId: peerId,
                        addresses: {
                        ...
                        services: {
                            pubsub: (0, libp2p_gossipsub_1.gossipsub)(options)
                        }
                    })];
            case 1:
                libp2p = _a.sent();
                libp2p.services.pubsub.addEventListener('message', function (message) {
                    console.log("".concat(message.detail.topic, ":"), new TextDecoder().decode(message.detail.data));
                });
